  ...
  <div>
    <main class="flex justify-center items-center flex-wrap">
      ...
      <div
        v-else
        :key="product.id"
        class="px-4 border border-gray-200 rounded-sm m-10 w-80"
      >
        ...
        <div class="space-y-4">
          ...
          <div>
            <button
              ...
              class="bg-black hover:bg-white hover:text-black mb-2 transition duration-200 ease-in border border-black text-white py-1.5 px-2 rounded-md"
            >
              Add To Cart
            </button>
          </div>
